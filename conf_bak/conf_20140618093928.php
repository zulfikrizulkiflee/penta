...
define('DB_USERNAME','corrad');			//db username
define('DB_PASSWORD','corrad');			//db pwd
define('DB_OTHERS','epili,epili_usr');				//other db, separate by comma (,)

//constants definition
define('SESSION_NAME','EPILI_DEV');
define('SYSTEM_NAME','ePili');
define('SYSTEM_FULL_NAME','Sistem Pengurusan Pili Bomba');
...
define('SYSTEM_HOME_PAGE','index.php?page=page_wrapper&menuID=64');
...
define('SESSION_TIMEOUT_DURATION',30);								//max duration,in minutes, of session per page (0 to disable)
//--------//LOGIN EXTRA OPTION-------------------------------------------
