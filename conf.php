...
define('DB_CONNECTION','localhost');		//connection/server
...
//define('PENTAHO_IP','http://10.1.219.36:8643');
define('PENTAHO_IP','http://sppb.999.gov.my:8643');



//--------APP SETTINGS----------------------------------------------------
define('APP_NAME','Penta');
...
//------INTEGRATION-------------------------------------
define('ENABLE_INTEGRATION','true');

define('EPILI_IS_DOMAIN','http://10.1.219.53/epili_is');
define('IP_EPILI_IS','10.1.219.53');
define('IP_EPILI','10.1.219.36');
define('API_CAD','http://10.0.60.200/sppb/services/SPPBService?wsdl');
...
//-----HAFIZ'S NOTE--------------JGN DELETE---------------

//http://10.1.219.34/epili/api_generator.php?api_name=API_TRANSMIT_PILI_BULK
