	...
	<tr>
      ...
      <td valign="top">
		  <select name="action" class="inputList" id="action" onChange="codeDropDown(this, 'showScreen');">
			  ...
			  <option value="opcache_gui" <?php if($_POST['action'] == 'opcache_gui') echo 'selected'; ?>>Zend OPcache status - Advanced</option>
...
<iframe src="admin/phpinfo/index.php" style="width:100%;height:1000px;"></iframe>
<?php } ?>
<br />
<?php if($_POST['action'] == 'xdebug') { ?>
<iframe src="admin/webgrind/index.php" style="width:100%;height:1000px;"></iframe>
<?php } ?>
<?php if($_POST['action'] == 'sysinfo') { ?>
<iframe src="admin/phpsysinfo/index.php" style="width:100%;height:1000px;"></iframe>
<?php } ?>
<?php if($_POST['action'] == 'opcache') { ?>
<iframe src="admin/opcache/opcache.php" style="width:100%;height:700px;"></iframe>
<?php } ?>
<?php if($_POST['action'] == 'opcache_gui') { ?>
<iframe src="admin/opcache-gui/index.php" style="width:100%;height:1000px;"></iframe>
<?php } ?>
<?php if($_POST['action'] == 'folderperm') {
$files = array('conf.php','a.php');
