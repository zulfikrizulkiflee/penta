...
?>
<div id="breadcrumbs">System Administator / Configuration / API Editor</div>
<h1>API Editor</h1> 
<?php }?>
...
<table width="100%" border="0" cellpadding="3" cellspacing="0" class="tableContent">
	...
	<tr>
	  ...
	  <td>
      	<input name="api_url" id="api_url" type="text" class="inputInput" value="<?php echo $api_url;?>" size="50" onchange="trim(this);" readonly />
      </td>
	</tr>
	<tr>
