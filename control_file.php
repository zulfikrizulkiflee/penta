...
function DisplayTableHeader()
{
	...
	$pdf->MultiCell($w=$width_col_no, $h=5*$max_height+3, $txt='No', $border=1, $align='L', $fill=1, $ln=0, $x='', $y='', $reseth=true, $stretch=0, $ishtml=false, $autopadding=true, $maxh=$h, $v='M');
	foreach ($sync_name_index as $key => $value)
	{
		$width_converted = GetAndConvertColumnWidth($value, $sync_name_index, $collectionWidth, $totalWidth, $pdf);
		$pdf->MultiCell($w=$width_converted, $h=5*$max_height+3, $txt=$value, $border=1, $align='C', $fill=1, $ln=0, $x='', $y='', $reseth=true, $stretch=0, $ishtml=false, $autopadding=true, $maxh=$h, $v='M');
	}
		...
		if($_GET['gen']=='pdf')
		{
			...
			class EXTTCPDF2 extends EXTTCPDF
			{
				...
				public function Header(){
					...
					$this->MultiCell($w=0, $h=5, $txt=strtoupper($this->title), $border='B', $align='L', $fill=0, $ln=0, $x='', $y='', $reseth=true, $stretch=0, $ishtml=false, $autopadding=true, $maxh=0, $v='M');
				}

				public function Footer(){
					$this->SetFont('helvetica','',9);
					$this->MultiCell($w=0, $h=5, $txt=$this->PageNo().' / '.$this->getAliasNbPages(), $border='', $align='C', $fill=0, $ln=0, $x='', $y='', $reseth=true, $stretch=0, $ishtml=false, $autopadding=true, $maxh=0, $v='M');
				}
			}
			...
			foreach ((array)$exe as $arr)
			{
				...
				$pdf->MultiCell($w=$pdf->PercentWidth(($collectionWidth[0]/$totalWidth)*100), $h=5*$max_height, $txt=$n, $border=1, $align='L', $fill=0, $ln=0, $x='', $y='', $reseth=true, $stretch=0, $ishtml=false, $autopadding=true, $maxh=$h, $v='M');

				//loop untuk display data
				foreach($arr as $key => $value)
				{
					$width_converted = GetAndConvertColumnWidth($key, $sync_name_index, $collectionWidth, $totalWidth, $pdf);
					$pdf->MultiCell($w=$width_converted, $h=5*$max_height, $txt=$value, $border=1, $align='L', $fill=0, $ln=0, $x='', $y='', $reseth=true, $stretch=0, $ishtml=false, $autopadding=true, $maxh=$h, $v='M');
				}
