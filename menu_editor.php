...
if($_POST['insert'])
{
	...
	//insert menu
	$insertMenu = "insert into FLC_MENU (MENUID, MENUNAME, MENUTITLE, MENUPARENT, MENULEVEL, MENUORDER, MENUTARGET, MENULINK, MENUSTATUS, MENUNOTES, MENUHINTS, MENUSTATE)
					values (".$maxIdRs.", '".$_POST['menuName']."', '".$_POST['menuTitle']."', ".$_POST['menuParent'].", ".($parentLevel+1).",
						...
						'".$_POST['menuNotes']."', '".$_POST['menuHints']."',".$_POST['menuState'].")";
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableContent">
    ...
    <tr>
      ...
      <td>
        ...
        <input id="menuId" name="menuId" type="hidden" value="<?php echo $menuId;?>" />
    ...
    <tr>
      ...
      <td>
      	<input id="menuTitle" name="menuTitle" type="text" class="inputInput" size="100" value="<?php echo $menuTitle;?>" />
